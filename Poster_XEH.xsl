...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html>
			<body background="https://Shuo-Qi.github.io/img/img_2.jpg" style="margin-left:200px;margin-top:50px;margin-right:200px; line-height:1.5;">
